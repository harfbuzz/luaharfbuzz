...
static const struct luahb_constant_t buffer_constants[] = {
  ...
  { "FLAG_VERIFY", HB_BUFFER_FLAG_VERIFY },
  { "FLAG_PRODUCE_UNSAFE_TO_CONCAT", HB_BUFFER_FLAG_PRODUCE_UNSAFE_TO_CONCAT },
  { "FLAG_PRODUCE_SAFE_TO_INSERT_TATWEEL", HB_BUFFER_FLAG_PRODUCE_SAFE_TO_INSERT_TATWEEL },
  { "FLAG_DEFINED", HB_BUFFER_FLAG_DEFINED },
  { "GLYPH_FLAG_UNSAFE_TO_BREAK", HB_GLYPH_FLAG_UNSAFE_TO_BREAK },
  { "GLYPH_FLAG_UNSAFE_TO_CONCAT", HB_GLYPH_FLAG_UNSAFE_TO_CONCAT },
  { "GLYPH_FLAG_SAFE_TO_INSERT_TATWEEL", HB_GLYPH_FLAG_SAFE_TO_INSERT_TATWEEL },
